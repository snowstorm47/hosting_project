...
const scales = [
  {
    name: "medium_instractor",
    title: "Medium Instractor",
  },
  {
    name: "higher_instractor",
    title: "Higher Instractor",
  },
  {
    name: "caf_d_instractor",
    title: "CAF D Instractor",
  },
  {
    name: "caf_c_instractor",
    title: "CAF C Instractor",
  },
  {
    name: "caf_b_instractor",
    title: "CAF B Instractor",
  },
  {
    name: "caf_a_instarctor",
    title: "CAF A Instractor",
  },
  {
    name: "caf_pro_instractor",
    title: "CAF Pro Instractor",
  },
  {
    name: "fifa_instractor",
    title: "FIFA Instractor",
  },
];
...
const AddEditInstructor = () => {
  ...
  const {
    loading: addInstactorLoading,
    success: addInstactorSuccess,
    error: addInstractorError,
  } = useSelector((state) => state.addInstactor);
  ...
  const onSubmitHandler = (values) => {
    ...
    dispatch(addInstractor(formData));
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <Modal open={addInstractorError}>
        <Dialog
          severity="failure"
          message="adding instractor failed !"
          close={() => dispatch(resetAddInstractor())}
        />
      </Modal>
      <Modal open={addInstactorSuccess}>
        <Dialog
          severity="success"
      ...
      <Modal open={addInstactorLoading}>
